...
const Footer: React.FC = () => {
  return (
    <footer
      id="contact"
      className="bg-brand-dark text-brand-sand pt-20 pb-10 px-6 rounded-t-[3rem] mt-12 relative overflow-hidden"
    >
      ...
      <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
        <motion.div
          ...
          className="mb-12"
        >
          <h2 className="text-5xl md:text-7xl font-serif font-bold mb-6 text-brand-sage">
            Let's Talk.
          </h2>
        ...
        {/* <div className="w-full border-t border-brand-sand/10 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-brand-sand/40">
          <p>
            &copy; {new Date().getFullYear()} Benjamin Rappoport. All rights
            reserved.
          </p>
          <p>
